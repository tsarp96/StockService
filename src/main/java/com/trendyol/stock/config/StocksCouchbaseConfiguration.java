package com.trendyol.stock.config;
...
@Configuration
public class StocksCouchbaseConfiguration {

    private final CouchbaseProperties couchbaseProperties;

    public StocksCouchbaseConfiguration(CouchbaseProperties couchbaseProperties) {
    ...
    @Bean
    public Collection stocksCollection(Cluster couchbaseCluster) {
